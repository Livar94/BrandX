...
export default function DekalPage() {
    ...
    <main className="min-h-screen bg-neutral-950 pt-32 pb-20">
      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="mb-10 text-center">
          <span className="inline-flex items-center rounded-full bg-white/5 px-3 py-1 text-xs font-medium uppercase tracking-[0.16em] text-emerald-300/90 ring-1 ring-white/10">
            Galleri · Dekaler
          </span>

          <h1 className="mt-4 text-4xl md:text-5xl font-semibold tracking-tight text-white">
            Dekaler som lyfter ditt varumärke
          </h1>

          <p className="mt-4 max-w-2xl mx-auto text-neutral-300 text-sm md:text-base">
            Fönsterdekaler, produktetiketter och specialklistermärken – vi tar
            fram dekaler som både håller över tid och känns rätt i din grafiska profil.
          </p>
        </div>
